...
if($_SERVER['REQUEST_METHOD']=='POST')
{
  ...
  $local = $_POST['local'];
  $query=pg_query("select * from usuario where cpf='$cpf'");
    if(pg_num_rows($query)){
      ...
      if(pg_num_rows($query)){
        ...
        pg_query("INSERT INTO usuario (nome,cpf,login,email,senha,local) VALUES ('$nome','$cpf','$login','$email','$senha','$local')");
...
<body class="hold-transition register-page" style="background-image: url(../assets/img/background_login.jpg);background-repeat:no-repeat;">
<div class="register-box">
  <div class="register-box-body">
    <img src="../assets/img/find_user.png" style="width:150px;height:150px" class="text-center col-xs-offset-3">
    <div class="register-logo">
    <a href="../../index2.html"><b>Cadastro</b> de usuário</a>
    </div>
    <form action="#" method="post" name="form1">
      <div class="form-group has-feedback">
          <select name="local">
            <option id="0" value=''>Selecione...</option>
            <option id="1">Almox. Saude</option>
            <option id="2">Almox. Educacao</option>
            <option id="3">Almox. Geral</option>
          </select> 
      </div>
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Nome Completo" name="nome" value="<?php echo $nome;?>"required="required">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="login" name="login" value="<?php echo $login;?>" required="required">
        <span class="glyphicon glyphicon-user form-control-feedback"</span>
      </div>
      <div class="form-group has-feedback">
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Confirme a Senha" name="confirma_senha" required="required">
        <span class="glyphicon glyphicon-log-in form-control-feedback"></span>
      </div>
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck col-xs-offset-1">
            <label>
