...
<body class="hold-transition login-page" style="background-image: url(../assets/img/background_login.jpg);background-repeat:no-repeat;background-size:100% 100%">
<div class="login-box">
  <!-- /.login-logo -->
  <div class="login-box-body">
        <img src="../assets/img/find_user.png" style="width:150px;height:150px" class="text-center col-xs-offset-3">
    <div class="login-logo">
    <b style="color:black">SGA</br><h4>(Sistema Gerenciador de Almoxarifado)</h4></b>
  </div>
    </br><p class="login-box-msg">Cadastre-se ou inicie sessão</p>

    <form action="" method="post">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Usuario" required="required" name="login" autofocus="">
